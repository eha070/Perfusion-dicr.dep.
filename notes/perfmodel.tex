...
\section{Restoring the porosity and flow field using deconvolution models}

We tested the the convolution based classical model \eqref{eq:Cconv1} as well as maximum-slope model (MS, [eq:?]) for their capability to recover the perfusion values.
...
\begin{table}[H]
	\caption{Results of the restoration with median relative errors}
	\centering
		\begin{tabular}{c c c c c c }
			 &Model & \multicolumn{4}{c}{Block Size}\\
			 & & (1,1) & (5,5) & (10,10) & entire domain \\
			\toprule
			\multirow{2}{*}{SFD} & MS & $170.09\%$ & $165.03\%$ & $158.57\%$ & $2.65\%$ \\
			 & bSVD & $859.06\%$ & $768.58\%$ & $664.84\%$ & $-1.25\%$ \\
			 \multirow{2}{*}{SCD} & MS & $-23.20\%$ & $-24.26\%$ & $-25.75\%$ & $54.78\%$ \\
			 & bSVD & $2.43\%$ & $-4.27\%$ & $-8.80\%$ & $-63.92\%$ \\
		\end{tabular}
...
\begin{figure}[H]
	...
	\centering
		\begin{tabular}{c c c}
			 \rbox{5ex}{Entire Domain}& \inc{C-and-Crec.eps} & \inc{Irec.eps} \\
