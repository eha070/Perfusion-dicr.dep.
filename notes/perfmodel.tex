...
We tested the classical model \eqref{eq:Cconv1} to restore the flow fields of the two simulations SF and SC. 
The deconvolution was performed using the block circulant approach described in [?] as well as the maximum slope technique [?].
Errors 
Results are displayed in Fig. \ref{fig:}
