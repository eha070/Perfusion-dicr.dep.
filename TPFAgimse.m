function [P,V]=TPFAgimse(Grid,K,q,voxelvol)
...
% NB!!!!
% The transmissibilities are already multiplied by the area of the faces,
% so what comes out is total flow per voxel: m^3/s!!!!!!!!!!!!! Not per area
