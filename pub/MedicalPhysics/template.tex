...
\documentclass[aps,prb,article,groupedaddress,showkeys]{revtex4}
...
\affiliation{Institute of Mathematics and Image Computing, University of L\"ubeck, Germany}
\author{Erik A. Hanson}
\affiliation{Department of Mathematics, University of Bergen, Norway}
\author{Alexander Malyshev}
\affiliation{Department of Mathematics, University of Bergen, Norway}
\author{Arvid Lundervold}
\affiliation{Department of Biomedicine, University of Bergen, Norway, and Department of Radiology, Haukeland University Hospital, Norway}
\author{Jan Modersitzki}
\affiliation{Institute of Mathematics and Image Computing, University of L\"ubeck, Germany}
\author{Erlend Hodneland}
\affiliation{Christian Michelsen Research, Bergen, Norway and MedViz Research Cluster, University of Bergen, Norway}
\thanks{Author to whom correspondence should be addressed.}
\email[Email: ]{erlend.hodneland@gmail.com}
...
\keywords{perfusion, DCE-MRI, Darcy flow, compartment modeling
}
\maketitle
