...
\begin{document}
	...
	In order to simulate different spatial resolutions of the scanning process, the data was averaged using different block-sizes ranging from $b_1 = (1,1)$ to $b_5=(64,64)$.
	Results are displayed in Figure \ref{fig:resultsSFD} as well as in Table \ref{tab:resultsSim}.
	...
	However, for the voxel-wise model
	The impuls-response function reconstructed from the Porous Media Model is displayed in Figure \ref{fig:deconvResults}.
