...
\begin{document}
	...
	We will first describe two standard models to recover CBF,CBV and MTT from data displaying propagation of a contrast agent (CA) through the tissue.
	The so-called Deconvolution Model (DM) is used in vast amount of publications \cite{ostergaard96,abels10,straka10,bivard13,sourbron13} and has been shown to yield accurate results.
	...
	Let $\Omega_i$ be a control volume exhibiting one inlet and one outlet and let the CA concentration within $\Omega_i$ at timepoint $t$ be denoted by $C(t)$.
