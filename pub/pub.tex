...
\begin{document}
	...
	Another key ingredient from porous media is the introduction of the porosity $\phi$ evans98where $0 \le \phi \le 1$.
	...
	In order to test the standard model for their ability to restore CBF and CBV, we need to convert flow with units \si{\siq} to perfusion with units \si{\siP}. A method to do that will be presented in Section \ref{sec:flow2perf}.
	...
	\section{A method to estimate the porosity}\label{sec:CBV}
