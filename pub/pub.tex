...
%	\tableofcontents
	...
	\begin{abstract}
		\textbf{Objective:}
		In perfusion imaging the usage of discretization dependent one-compartment models for estimation of haemodynamic parameters like perfusion, blood volume and mean transit times is widespread. In this paper we set up a mathematical framework for quantification of the error occurring related to perfusion recovery.
		\textbf{Methods:}
	...
	In the current work we want to focus on the problem of perfusion as a discretization dependent measure. This fundamental problem of perfusion as defined within traditional one-compartment models was previously identified by several authors \cite{Henkelman1990,Guibert2013,sourbron14}. Perfusion defined as flow entering a voxel will scale with voxel size, and this notion of perfusion is therefore inappropriate. This limitation has not been sufficiently well addressed in clinical studies on absolute perfusion. 
