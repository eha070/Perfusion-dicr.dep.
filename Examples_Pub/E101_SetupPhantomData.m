% ------------------------------------------------------------------------- 
%                               E101_SetupPhantomData
%
% This file sets up the synthetic perfusion model.
% All control variables can be found in the first section.
% All Experiments of the paper have been performed with the downsampled
% data.
% 
% 
